...
export function StatCard({
  ...
  return (
    <a
      ...
      className="animate-stat-in flex min-h-[44px] flex-col gap-2 rounded-xl border border-surface-border bg-white p-4 transition-shadow hover:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-brand"
    >
